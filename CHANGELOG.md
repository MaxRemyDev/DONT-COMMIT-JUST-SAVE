...
-   Minimalist text of dialogs, alert and reset confirmation (shorter copy, force-push callout)
...
-   Soft reset command to run `git reset --soft HEAD~N` with validation and confirmation

### Changed

-   More robust pull detection

### Fixed

-   Confirmation modal dialog is now displayed when required

## [1.2.0] - 2025-10-16

-   Clean up the project by removing unwork features
